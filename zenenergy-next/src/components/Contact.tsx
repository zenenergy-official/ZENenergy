      ...
      <div className="container">
        ...
        <div className="contact-grid">
          <div className="contact-card" data-aos="fade-up" data-aos-delay="100">
            <h3 className="font-bold">Електронна пошта</h3>
          ...
          <div className="contact-card" data-aos="fade-up" data-aos-delay="200">
            <h3 className="font-bold">Соціальні мережі</h3>
            <p><a href="https://instagram.com/zenenergy.official" target="_blank">Instagram @zenenergy.official</a></p>
          </div>
